...
class RelationshipTest extends DatabaseTest
{
	...
	public function test_gh_256_eager_loading_three_levels_deep()
	{
		...
		$conditions['includes'] = array('events'=>array('host'=>array('events')));
	...
	public function test_gh93_and_gh100_eager_loading_respects_association_options()
	{
		...
		$venues = Venue::find(array(2, 6), array('includes' => 'events'));
	...
	{
		$venues = Venue::find(array(7, 8), array('includes' => 'events'));
	...
	public function test_eager_loading_has_many_array_of_includes()
	{
		...
		$authors = Author::find(array(1,2), array('includes' => array('books', 'awesome_people')));
	...
	{
		$venues = Venue::find(array(1,2), array('includes' => array('events' => array('host'))));
	...
	{
		$events = Event::find(array(1,2,3,5,7), array('includes' => 'venue'));
	...
	{
		$events = Event::find(array(1,2,3,5,7), array('includes' => array('venue', 'host')));
	...
	public function test_eager_loading_belongs_to_nested()
	{
		...
		$books = Book::find(array(1,2), array('includes' => array('author' => array('awesome_people'))));
	...
	public function test_eager_loading_belongs_to_with_no_related_rows()
	{
		...
		$events = Event::find(array($e1->id, $e2->id), array('includes' => 'venue'));
	...
	{
		$events = Event::find(array(2,3), array('includes' => array('venue')));
	...
	{
		$venues = Venue::find(array(1,2,6,9), array('includes' => array('events' => array('host'))));
	...
	{
		Author::find(999999, array('includes' => array('books')));
	}
};
?>
